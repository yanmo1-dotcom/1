...
public class TileMapAssets {
    ...
    public TileMapAssets(String mapPath) {
        ...
        this.tilesWide = props.get("width", Integer.class);
        this.tilesHigh = props.get("height", Integer.class);
        this.tilePixelWidth = props.get("tilewidth", Integer.class);
        this.tilePixelHeight = props.get("tileheight", Integer.class);
